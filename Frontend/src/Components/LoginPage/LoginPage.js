              ...
              <div className="card-body p-3 p-lg-4 text-black">
                <form>
                  <div className="d-flex align-items-center mb-2 pb-1">
                    <i
                      className="fas fa-car fa-2x me-3"
                      style={{ color: "#ff6219" }}
                    ></i>
                  ...
                  <div className="align-items-center mb-3 pb-1">
                    <span className="h3 fw-bold mb-0 greet-hello">Hello,</span>
                    <br />{" "}
                    <span className="h1 fw-bold mb-0 greet-wlcm">Welcome!</span>
                  </div>
                  ...
                  <NavLink to="#" className="small text-muted" href="#!">
                    Forgot password?
                  </NavLink>
                  ...
                  {!isuser?<span style={{color:"red",fontSize:"20px"}}>
